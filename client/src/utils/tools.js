...
function setScreen() {
  if (!enableScreenShare) {
    ...
    navigator.mediaDevices.getDisplayMedia({ cursor: true, ...constraints }).then((stream) => {
    ...
    shareScreenBtn.innerText = "Stop Screen Share";
  } else {
...
function stopScreen() {
  ...
  .then((stream) => {
    ...
    localVideo.srcObject = stream;
    localStream = stream;
    shareScreenBtn.innerText = "Screen Share";
  })
  .catch((e) => alert(`getusermedia error ${e.name}`));
}
